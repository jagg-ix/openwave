...
COMPTON_WAVELENGTH_REDUCED_ELECTRON = 3.8615926796e-13  # m, ℏ / (m_e * c), CODATA 2022
COMPTON_WAVELENGTH_REDUCED_PROTON = 2.10308910336e-16  # m, ℏ / (m_p * c), CODATA 2022
COMPTON_WAVELENGTH_REDUCED_NEUTRON = 2.10019415255e-16  # m, ℏ / (m_n * c), CODATA 2022
COMPTON_WAVELENGTH_REDUCED_ELECTRON_AM = 3.8615926796e5  # am, ℏ / (m_e * c) in attometer units
