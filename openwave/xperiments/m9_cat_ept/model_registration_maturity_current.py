"""Current M9.100 registration with criterion maturity v2."""
...
from .model_conformance_maturity_current import canonical_payload as conformance_payload
from .model_conformance_maturity_current import run_conformance_study
...
def run_model_registration_study() -> dict[str, Any]:
    ...
    acceptance = {
        ...
        "schema_v8_is_current": payload["schema"] == "openwave.model-registration.v8",
