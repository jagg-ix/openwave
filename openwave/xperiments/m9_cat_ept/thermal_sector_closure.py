...
def run_thermal_sector_closure() -> dict[str, Any]:
    ...
    acceptance = {
        ...
        "total_heat_conservation_closes": thermal["acceptance"][
            "total_heat_is_conserved"
        ],
        "entropy_monotonicity_closes": thermal["acceptance"][
            "thermal_entropy_is_monotone"
        ],
        "diffusion_dissipation_identity_closes": thermal["acceptance"][
            "diffusion_dissipation_identity_closes"
        ],
        "semigroup_property_closes": thermal["acceptance"][
            "semigroup_property_closes"
        ],
        "zero_diffusivity_control_closes": thermal["acceptance"][
            "zero_diffusivity_freezes_field"
        ],
        "resolution_control_closes": thermal["acceptance"][
    ...
    return {
        ...
        "thermal_controls": {
            "initial": thermal["initial"],
            "final": thermal["final"],
            "entropy_increase": thermal["entropy_increase"],
            "variance_decrease": thermal["variance_decrease"],
            "mode_decay": thermal["mode_decay"],
            "dissipation_identity": thermal["dissipation_identity"],
            "semigroup": thermal["semigroup"],
            "zero_diffusivity": thermal["zero_diffusivity"],
            "resolution": thermal["resolution"],
        },
        "acceptance": acceptance,
        "passed": all(acceptance.values()),
        "decision": {
            "thermal_field_sector_validated_in_platform": True,
            "dimensionless_heat_entropy_dissipation_sector_established": True,
            "microscopic_cat_ept_thermodynamics_derived": False,
            "material_transport_coefficients_calibrated": False,
            "relativistic_heat_conduction_established": False,
        },
    }
