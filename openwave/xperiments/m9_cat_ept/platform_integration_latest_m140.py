"""Fail-closed public integration contract for the M9.140 latest aliases."""
...
from .canonical_particle_model_m140 import run_canonical_model_contract
...
SCHEMA = "openwave.m9.platform-integration-latest.v1"
...
def run_platform_integration_contract() -> dict[str, Any]:
    ...
    acceptance = {
        ...
        "stable_alias_is_distinct_from_latest": (
            ...
            and registration["latest_milestone"] == "M9.140"
        ),
        "public_documents_expose_stable_and_latest_lineage": all(
