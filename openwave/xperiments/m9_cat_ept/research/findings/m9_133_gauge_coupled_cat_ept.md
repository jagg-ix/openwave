...
The public repository runs focused M9.132 and M9.133 validation in GitHub Actions on Python 3.12. The workflow compiles the coupled modules and executes their dedicated pytest files without installing the unrelated GUI/Taichi application stack.
