...
- **M9.70:** PhysLib proves the exact cubic--quintic density factorization and lower bound. An `H1OrbitalCertificate` makes flow, conservation, compactness modulo symmetry, and coercivity explicit and yields a uniform orbital-distance theorem. The current branch adds ZIL scope records and a dedicated axiom/non-vacuity audit. Construction of the analytic certificate fields from the spatial PDE remains open.
...
| PhysLib current M9.70 branch | `da74f64d17627f85d424499c21dd38157a5d2b4b` | audited density coercivity and conditional orbital certificate |
