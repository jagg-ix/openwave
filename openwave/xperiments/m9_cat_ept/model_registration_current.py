...
from .model_registration_m126 import canonical_registration_payload as _payload, run_model_registration_study as _run
CURRENT_MILESTONE="M9.126"; CURRENT_SCHEMA="openwave.model-registration.v29"; CURRENT_MODULE="openwave.xperiments.m9_cat_ept.model_registration_m126"; CURRENT_ALIAS_MODULE="openwave.xperiments.m9_cat_ept.model_registration_current"; CURRENT_CONFORMANCE_RUNNER="openwave.xperiments.m9_cat_ept.model_conformance_current:run_conformance_study"
...
def canonical_registration_payload()->dict[str,Any]:
 v=_payload(); return {**v,"registration":asdict(M9_REGISTRATION),"current_alias":{"milestone":CURRENT_MILESTONE,"module":CURRENT_ALIAS_MODULE,"versioned_module":CURRENT_MODULE,"conformance_runner":CURRENT_CONFORMANCE_RUNNER}}
def canonical_payload()->dict[str,Any]:return canonical_registration_payload()
