"""README/MODELS-aligned CAT/EPT conformance profile through M9.77."""
...
CRITERIA: tuple[Criterion, ...] = (
    ...
    C("de_broglie_clock", "particles", "de Broglie clock (Zitterbewegung)", "partial", (ROOT + "intrinsic_clock_reduction.py", ROOT + "imaginary_action_backreaction.py", ROOT + "entropic_integrator.py", ROOT + "physical_calibration_ledger.py", ROOT + "preregistered_breathing_prediction.py", ROOT + "independent_breathing_comparison.py", ROOT + "replacement_mode_prediction.py", ROOT + "independent_mode_robustness.py", FINDINGS + "m9_65_method_note.md", FINDINGS + "m9_68_method_note.md", FINDINGS + "m9_71_method_note.md", FINDINGS + "m9_74_method_note.md", FORMAL_STATUS), "PhysLib proves a scoped operational entropic/physical proper-time equality. The M9.65 Gaussian breathing prediction fails its no-refit comparison. The M9.71 stationary-branch ratio 1.074356835825 passes held-out grids and the independent M9.74 radial-amplitude/periodogram test. No external experiment or physical Zitterbewegung identification is established."),
    C("particle_stability", "particles", "Particle stability (Derrick escape)", "partial", (ROOT + "minimizer_3d.py", ROOT + "stability_campaign_3d.py", ROOT + "unified_self_binding_3d.py", ROOT + "non_gaussian_self_binding.py", ROOT + "action_derived_binding.py", ROOT + "binding_axiom_selection.py", ROOT + "orbital_compactness_bridge.py", ROOT + "coefficient_self_consistency.py", ROOT + "cubic_quintic_continuum.py", ROOT + "selection_condition_derivation_audit.py", ROOT + "h1_orbital_adversarial.py", ROOT + "stationary_non_gaussian_branch.py", ROOT + "h1_kernel_certificate.py", ROOT + "h1_concentration_closure.py", ROOT + "hminus_one_mild_flow_audit.py", ROOT + "recentered_compactness_audit.py", ROOT + "global_mild_orbit_campaign.py", FINDINGS + "m9_49_method_note.md", FINDINGS + "m9_52_method_note.md", FINDINGS + "m9_59_method_note.md", FINDINGS + "m9_60_method_note.md", FINDINGS + "m9_61_method_note.md", FINDINGS + "m9_63_method_note.md", FINDINGS + "m9_64_method_note.md", FINDINGS + "m9_66_method_note.md", FINDINGS + "m9_67_method_note.md", FINDINGS + "m9_69_method_note.md", FINDINGS + "m9_70_method_note.md", FINDINGS + "m9_72_method_note.md", FINDINGS + "m9_73_method_note.md", FINDINGS + "m9_75_method_note.md", FINDINGS + "m9_76_method_note.md", FINDINGS + "m9_77_method_note.md"), "The original action disperses, while M9.69 constructs a localized non-Gaussian stationary branch. The live formal stack proves complete H1/Born compactness, Hartree interaction closure, energy-split no-loss, compact minimizing orbits, and the Cazenave--Lions stability mechanism. M9.75 rejects the false bounded H1-to-H1 Laplacian premise and the false global weak-closure/lower-semicontinuity premises, replacing them with a weak H1-to-H-minus-one interface and localized interaction closure. M9.76 qualifies recentering and first-moment/tail control. M9.77 keeps five perturbation classes in a small aligned H1 tube with mass and energy controls. The concrete energy-critical Duhamel flow, continuum conservation, analytic branch identification, calibration, and a physical particle remain open."),
...
def canonical_payload() -> dict[str, Any]:
    return {"schema": "openwave.m9.models-conformance.v8", "model": "M9 CAT/EPT", "criteria": [asdict(item) for item in CRITERIA], "audit": validate_profile()}
...
def run_conformance_study() -> dict[str, Any]:
    ...
    acceptance = {
        ...
        "m9_77_status_counts": payload["audit"]["status_counts"] == {"validated": 0, "partial": 20, "negative": 1, "not_yet": 0},
        "m9_75_77_stability_evidence_present": all(any(name in path for path in stability["evidence"]) for name in ("m9_75_method_note.md", "m9_76_method_note.md", "m9_77_method_note.md")),
        "false_h1_generator_premise_is_rejected": "false bounded H1-to-H1 Laplacian premise" in stability["finding"],
