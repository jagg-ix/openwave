"""README/MODELS-aligned CAT/EPT conformance profile through M9.83."""
...
def run_conformance_study() -> dict[str, Any]:
    ...
    acceptance = {
        ...
        "m9_83_status_counts": payload["audit"]["status_counts"] == {"validated": 3, "partial": 17, "negative": 1, "not_yet": 0},
