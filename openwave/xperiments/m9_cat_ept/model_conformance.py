...
CRITERIA: tuple[Criterion, ...] = (
    ...
    Criterion("electron_rest_energy", "particles", "Electron rest energy (mass)", "partial", ("openwave/xperiments/m9_cat_ept/scale_selection.py", "openwave/xperiments/m9_cat_ept/research/findings/m9_27_method_note.md", "openwave/xperiments/m9_cat_ept/physical_calibration_ledger.py", "openwave/xperiments/m9_cat_ept/research/findings/m9_62_method_note.md"), "A selected topological ansatz has an interior dimensionless scale minimum. M9.62 records the mass anchor as calibration-required; no out-of-sample physical mass prediction is established."),
    Criterion("de_broglie_clock", "particles", "de Broglie clock (Zitterbewegung)", "partial", ("openwave/xperiments/m9_cat_ept/intrinsic_clock_reduction.py", "openwave/xperiments/m9_cat_ept/imaginary_action_backreaction.py", "openwave/xperiments/m9_cat_ept/entropic_integrator.py", "openwave/xperiments/m9_cat_ept/physical_calibration_ledger.py", "openwave/xperiments/m9_cat_ept/research/formal_status_matrix.md"), "OpenWave separates reversible phase, entropic monotone, and geometry clock channels. PhysLib proves a scoped operational entropic/physical proper-time equality in the positive imaginary-Einstein sector; an independently calibrated OpenWave clock and physical Zitterbewegung identity remain open."),
    Criterion("particle_stability", "particles", "Particle stability (Derrick escape)", "partial", ("openwave/xperiments/m9_cat_ept/minimizer_3d.py", "openwave/xperiments/m9_cat_ept/stability_campaign_3d.py", "openwave/xperiments/m9_cat_ept/unified_self_binding_3d.py", "openwave/xperiments/m9_cat_ept/non_gaussian_self_binding.py", "openwave/xperiments/m9_cat_ept/action_derived_binding.py", "openwave/xperiments/m9_cat_ept/binding_axiom_selection.py", "openwave/xperiments/m9_cat_ept/orbital_compactness_bridge.py", "openwave/xperiments/m9_cat_ept/research/findings/m9_49_method_note.md", "openwave/xperiments/m9_cat_ept/research/findings/m9_52_method_note.md", "openwave/xperiments/m9_cat_ept/research/findings/m9_59_method_note.md", "openwave/xperiments/m9_cat_ept/research/findings/m9_60_method_note.md", "openwave/xperiments/m9_cat_ept/research/findings/m9_61_method_note.md"), "The original unified and five-family scans disperse. M9.59 selects a bounded finite-grid candidate; M9.60 identifies the cubic Born-density law as unique only inside an explicit formal class and the quintic as a minimal bounded polynomial extension; M9.61 adds a normalized-Gaussian variational well and tightness proxy. Arbitrary-H1 orbital stability, coefficient selection, and physical calibration remain open."),
    Criterion("magnetic_moment_spin", "particles", "Magnetic moment and spin J", "partial", ("openwave/xperiments/m9_cat_ept/spin_magnetic_observables.py", "openwave/xperiments/m9_cat_ept/research/findings/m9_29_method_note.md", "openwave/xperiments/m9_cat_ept/physical_calibration_ledger.py"), "Spin and a Pauli-current magnetic moment are field-integrated controls; no emergent calibrated electron g factor or stable physical particle is established."),
    ...
    Criterion("lepton_mass_spectrum", "particles", "Lepton mass spectrum (mu, tau)", "negative", ("openwave/xperiments/m9_cat_ept/lepton_hierarchy_audit.py", "openwave/xperiments/m9_cat_ept/research/findings/m9_39_method_note.md", "openwave/xperiments/m9_cat_ept/physical_calibration_ledger.py"), "Current geometric and effective-scale candidate laws fail predictive gates; exact three-parameter interpolation has zero residual degrees of freedom. M9.62 records no prediction-ready lepton hierarchy."),
    Criterion("dark_matter", "particles", "Dark matter candidate", "partial", ("openwave/xperiments/m9_cat_ept/dark_sector_survey.py", "openwave/xperiments/m9_cat_ept/research/findings/m9_45_method_note.md"), "An electrically neutral fixed-global-charge Gaussian survey finds a finite-charge bound candidate; full-PDE stability, abundance, and phenomenology remain open."),
    Criterion("quarks", "particles", "Quarks", "partial", ("openwave/xperiments/m9_cat_ept/quark_color_sector.py", "openwave/xperiments/m9_cat_ept/research/findings/m9_46_method_note.md", "openwave/xperiments/m9_cat_ept/research/zil/m9_46_quark_color.zc"), "Finite SU(3) color, singlet, Wilson-loop, fractional-charge, and CKM controls exist; dynamical QCD, emergent quarks, and physical hadron spectra remain open."),
    ...
    Criterion("strong_force", "forces", "Strong force / confinement", "partial", ("openwave/xperiments/m9_cat_ept/confinement_sector.py", "openwave/xperiments/m9_cat_ept/research/findings/m9_40_method_note.md"), "A reduced Cornell/flux-tube control has linear potential growth, a constant-force asymptote, and a string-breaking ledger; QCD and dynamical color fields remain open."),
    Criterion("weak_force", "forces", "Weak force", "partial", ("openwave/xperiments/m9_cat_ept/weak_chiral_sector.py", "openwave/xperiments/m9_cat_ept/research/findings/m9_41_method_note.md"), "A reduced left-selective flavor-mixing and decay ledger is qualified; electroweak gauge dynamics, W/Z fields, and physical rates remain open."),
    Criterion("gravity", "forces", "Gravity", "partial", ("openwave/xperiments/m9_cat_ept/geometry_backreaction.py", "openwave/xperiments/m9_cat_ept/equivalence_principle.py", "openwave/xperiments/m9_cat_ept/formal_action_generator_bridge.py", "openwave/xperiments/m9_cat_ept/physical_calibration_ledger.py", "openwave/xperiments/m9_cat_ept/research/formal_status_matrix.md"), "OpenWave has weak-field and equivalence-principle controls. PhysLib provides scoped metric-built Einstein--Maxwell--entropic action/PDE interfaces, global action and ADM infrastructure, and a calibrated positive-imaginary-Einstein clock theorem. A concrete calibrated coupled physical evolution remains open."),
    Criterion("em_waves", "waves", "EM waves (Maxwell)", "partial", ("openwave/xperiments/m9_cat_ept/wave_reductions.py", "openwave/xperiments/m9_cat_ept/spatial_3d_controls.py", "openwave/xperiments/m9_cat_ept/formal_action_generator_bridge.py", "openwave/xperiments/m9_cat_ept/research/formal_status_matrix.md"), "A transverse Maxwell reduction and massless bridge are computationally qualified; PhysLib contains scoped intrinsic and distributional Maxwell interfaces. A common calibrated CAT/EPT electromagnetic sector with constructed Cauchy data remains open."),
    ...
    Criterion("thermal_field", "thermal", "Heat / thermal-field sector", "partial", ("openwave/xperiments/m9_cat_ept/thermal_field.py", "openwave/xperiments/m9_cat_ept/research/findings/m9_44_method_note.md", "openwave/xperiments/m9_cat_ept/physical_calibration_ledger.py"), "A periodic heat equation conserves total heat, increases normalized thermal entropy, and satisfies diffusion-dissipation controls; microscopic calibrated CAT/EPT thermodynamics remain open."),
)
...
def validate_profile(criteria: tuple[Criterion, ...] = CRITERIA) -> dict[str, Any]:
    keys = [x.key for x in criteria]
    labels = [x.label for x in criteria]
    ...
    if any(x.status != "not_yet" and not x.evidence for x in criteria):
...
def canonical_payload() -> dict[str, Any]:
    return {"schema": "openwave.m9.models-conformance.v3", "model": "M9 CAT/EPT", "criteria": [asdict(x) for x in CRITERIA], "audit": validate_profile()}
...
def run_conformance_study() -> dict[str, Any]:
    ...
    stability = next(x for x in payload["criteria"] if x["key"] == "particle_stability")
    clock = next(x for x in payload["criteria"] if x["key"] == "de_broglie_clock")
    acceptance = {
        ...
        "single_honest_negative_preserved": sum(x["status"] == "negative" for x in payload["criteria"]) == 1,
        ...
        "m9_62_status_counts": payload["audit"]["status_counts"] == {"validated": 0, "partial": 20, "negative": 1, "not_yet": 0},
        "m9_60_61_stability_evidence_present": all(any(name in path for path in stability["evidence"]) for name in ("m9_60_method_note.md", "m9_61_method_note.md")),
        "m9_62_falsification_ledger_present": any("physical_calibration_ledger.py" in path for row in payload["criteria"] for path in row["evidence"]),
        "scoped_clock_evidence_not_promoted": clock["status"] == "partial" and any("formal_status_matrix.md" in path for path in clock["evidence"]),
    }
