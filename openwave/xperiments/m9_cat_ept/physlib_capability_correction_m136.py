...
SOURCES = {
 ...
 "one_level_cross_observable":{"path":"Physlib/QuantumMechanics/OpenSystems/LindbladDrivenLeads/OneLevelCrossObservable.lean","blob":"d99136a02b3d09fa5338f8187ebf023e47be91f0","declarations":("lorentzPeak_eq_halfMaximum_iff","lorentzHWHM_eq_gamma","lorentzFWHM_eq_two_gamma","RateData.predictedOccupation_at_populationRelaxationTime","RateData.ofInOutRates_populationRelaxationTime","calibrated_rate_linewidth_relaxation_KL_chain")},
...
def canonical_payload()->dict[str,Any]:
 return {"schema":"openwave.m9.physlib-capability-correction.v2","repository":FORMAL_REPOSITORY,"branch":FORMAL_BRANCH,"formal_head":FORMAL_HEAD,"sources":SOURCES,"completed":COMPLETED,"open":OPEN,"zil_metrics":ZIL_METRICS,"decision":{"prior_report_materially_understated_gravity_maxwell_and_clock_coverage":True,"relaxation_kl_linewidth_chain_is_formally_closed":True,"empirical_model_selection_remains_open":True,"physical_claims_promoted":[]}}
...
def run_physlib_capability_correction()->dict[str,Any]:
 ...
 acceptance={
  ...
  "latest_formal_head_is_pinned":len(FORMAL_HEAD)==40,
  ...
  "calibrated_cross_observable_chain_is_closed":all(COMPLETED[k] for k in ("assembled_rate_kl_linewidth_theorem","hwhm_eq_rate_data_gamma","fwhm_eq_two_rate_data_gamma","t1_eq_inv_two_rate_data_gamma","exact_kl_derivative")),
  "empirical_obligations_remain_open":OPEN["experimental_cross_carrier_validation"] and OPEN["pure_dephasing_model_selection"],
