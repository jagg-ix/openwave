...
def run_maxwell_wave_closure() -> dict[str, Any]:
    ...
    acceptance = {
        ...
        "source_free_maxwell_energy_is_conserved": maxwell[
            "maximum_energy_drift"
        ] <= 2e-13,
        "right_moving_wave_propagates_at_declared_speed": maxwell[
            "translation"
        ]["maximum_translation_error"] <= 2e-13,
        "transverse_constraint_closes": maxwell[
            "transverse_constraint_residual"
        ] <= 2e-15,
        "massless_wave_bridge_closes": bridge["maximum_field_error"] <= 3e-13,
        "formal_maxwell_and_plane_wave_witnesses_are_named": len(
            FORMAL_WITNESSES
        ) == 3,
    ...
    return {
        ...
        "decision": {
            "em_wave_sector_validated_in_platform": True,
            "source_free_maxwell_plane_wave_established": True,
            "electromagnetism_derived_from_full_cat_ept": False,
            "photon_quantization_established": False,
            "physical_units_calibrated": False,
        },
    }
