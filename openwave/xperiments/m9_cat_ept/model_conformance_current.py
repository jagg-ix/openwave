"""Stable current M9 conformance entry point through M9.121.

The evidence-derived 21-criterion maturity profile last changed at M9.109.
M9.110--M9.121 add implementation evidence without promoting physical identity,
calibration, or external-validation axes.
"""
...
CURRENT_REGISTRATION_MODULE = "openwave.xperiments.m9_cat_ept.model_registration_m121"
...
def run_conformance_study() -> dict[str, Any]:
    ...
    acceptance = {
        ...
        "M9_121_evidence_authority_passes": bool(evidence["passed"]),
        ...
        "current_registration_is_v24": current_registration["schema"]
        ...
        == [],
        "external_promotion_remains_blocked": not current_registration["m9_121"][
    ...
    return {
        **payload,
        ...
        "decision": {
            "M9_121_is_current_evidence_milestone": True,
