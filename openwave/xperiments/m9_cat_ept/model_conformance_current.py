...
# Historical M9.97 overlays import the criterion tuple from this moving alias.
# Keep that exported tuple pinned to the explicit M9.96 compatibility profile,
# while current study execution remains versioned at M9.126 below.
...
def _dependencies():
    """Load versioned current authorities without traversing moving aliases."""
