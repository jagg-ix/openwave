...
| 1 extension , the author-collaboration track 🔶 | M7.8, M7.9, M7.10 + reserved M7.11-M7.14 | the helicity-pair 3:1 test + the Phase 1 walkthrough (M7.8, GO at the 2026-07-06 call); the ChaosBook study + canonical-exercise benchmark (M7.9); the pure-Maxwell no-Lagrangian test (M7.10, the Maxwell-track bootstrap); the rest of the Beltrami orbit track reserved (M7.11-M7.14, post-August); the walkthrough bundles the three tasks' results into one author-facing report |
