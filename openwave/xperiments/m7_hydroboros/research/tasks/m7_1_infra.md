...
| **S&Y toroidal Beltrami** | Sato-Yamada eikonal + equal-scale-factor recipe ([`../../theory/sato_yamada_beltrami.md`](../../theory/_CITATIONS.md)) | toroidal constant-λ seeds (M7.4) |
...
| **Ceperley rotating modes** | `J_m(k_c r)` Bessel-envelope rotating waves ([`../../theory/ceperley_rotating_waves.md`](../../theory/_CITATIONS.md) § 4) | the M7.2 Bessel stretch; smooth-envelope alternatives to the Heaviside mask |
