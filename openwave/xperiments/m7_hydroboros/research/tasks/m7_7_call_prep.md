...
Phase 2 ([roadmap](../m7_roadmap.md), M7.8-M7.14): the helicity-pair test (pending § 3), then magnetic force, gravity, nuclear, annihilation, lepton / neutrino family, dark matter; the coverage column stays staged in [`preview_models.md`](../preview_models.md) until the research matures (M7.15).
