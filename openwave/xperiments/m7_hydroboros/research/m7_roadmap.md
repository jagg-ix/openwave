...
| **M7.9** | Magnetic force | `scripts/m7_9_magnetic_force.py` |
| **M7.10** | Gravity | `scripts/m7_10_gravity.py` |
| **M7.11** | Strong force / confinement · Weak force | `scripts/m7_11_nuclear_forces.py` |
| **M7.12** | Antimatter + annihilation | `scripts/m7_12_annihilation.py` |
| **M7.13** | Neutrinos · Lepton mass spectrum (μ, τ) | `scripts/m7_13_lepton_neutrino.py` |
...
| TaskID | Task title | Description | Validation gate |
| --- | --- | --- | --- |
| M7.16 | composites + atomic structure | quark = fractional-charge string segment; baryon / meson = linked / twisted knots; atom = pilot-wave orbital quantization | Quarks · Baryons (p, n) · Mesons (π, K) · Orbital quantization |
