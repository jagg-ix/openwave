...
| Antimatter + annihilation | 🚧 [not yet tested]<br>M7.11 target (soliton + anti-soliton, charge ledger); the real-time route is blocked by the vacuum tachyon (Q14) until the full model's cure is known<br>[`m7_question_tracker.md`](m7_question_tracker.md) |
| Neutrinos | 🚧 [not yet tested]<br>M7.12 target: the lighter neutral loop of the lepton family<br>(none yet) |
| Lepton mass spectrum (μ, τ) | 🚧 [not yet tested]<br>M7.12 target; prerequisite discovered: fixing only global helicity permits reconnection into one Taylor family (E = 0.802\|H_A\|), so distinct knot sectors need topology-preserving constraints<br>[`m7_4_charged_soliton.md`](tasks/m7_4_charged_soliton.md) |
| Dark matter candidate | 🚧 [not yet tested]<br>M7.13 target: the neutral helicity-only knot, inheriting M6's chaoiton<br>(none yet) |
| Quarks | 🚧 [not yet tested]<br>M7.15 (composites)<br>(none yet) |
| Baryons (p, n) | 🚧 [not yet tested]<br>M7.15 (composites)<br>(none yet) |
| Mesons (π, K) | 🚧 [not yet tested]<br>M7.15 (composites)<br>(none yet) |
...
| Magnetic force | 🚧 [not yet tested]<br>M7.8 target (the clock-carried per-defect magnetic structure)<br>(none yet) |
| Strong force / confinement | 🚧 [not yet tested]<br>M7.10 target (4th-order short-range roll-off + linking tension)<br>(none yet) |
| Weak force | 🚧 [not yet tested]<br>M7.10 target (topology-reconnection channel; the M7.4 reconnection observation is the seed)<br>[`m7_4_charged_soliton.md`](tasks/m7_4_charged_soliton.md) |
| Gravity | 🚧 [not yet tested]<br>M7.9 target; honestly hard: the parent framework stops before gravity<br>(none yet) |
...
| Orbital quantization (atomic structure) | 🚧 [not yet tested]<br>M7.15 target<br>(none yet) |
