...
> Rigor standard: [`../../m5_liquid_crystal/research/11a_vortex_loop.md`](../../m5_liquid_crystal/research/tasks/m5.11a_vortex_loop.md) (M5.11).
...
| **11a rigor standard** ([`m5.11a_vortex_loop.md`](../../m5_liquid_crystal/research/tasks/m5.11a_vortex_loop.md)) | energy-minimizer to `‖∇E‖ → 0`, AD-validated gradient (`1e-12`), each task gated against a known result, honest pass/fail (§ 5, the [roadmap](m7_roadmap.md)) |
...
[`../../m5_liquid_crystal/research/1b_topological_defect.md`](../../m5_liquid_crystal/research/tasks/m5.1b_topological_defect.md)
...
- Rigor standard: [`../../m5_liquid_crystal/research/11a_vortex_loop.md`](../../m5_liquid_crystal/research/tasks/m5.11a_vortex_loop.md) (M5.11 vortex-loop)
...
- EM ≡ hydrodynamics bridge (already in M5): [`../../m5_liquid_crystal/research/1b_topological_defect.md`](../../m5_liquid_crystal/research/tasks/m5.1b_topological_defect.md) § "EM-hydrodynamics formal equivalence"
