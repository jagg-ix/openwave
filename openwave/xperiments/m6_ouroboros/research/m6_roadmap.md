...
| --- | --- | --- | --- |
| (none) | | M6.4 is next (branch-independent by design); the decision gate closed on branch (b) 2026-07-20 | |
...
| Question | Answer |
| --- | --- |
| Where is M6? | The refresh day (2026-07-20) ran the whole decision arc: refreshed from "permanent hold" → re-scoped (frozen-v11 ledger) → M6.1 ✅ (the certified convention sheet) → **M6.2 ✅ THE DECISION GATE, branch (b)**: the electron sector closed honestly (three MODELS.md cells → ❌). Remaining live: M6.4 (branch-independent); M6.3 joined the parked programs |
...
| What decided the program? | M6.2 (2026-07-20): the pre-registered no-search H/Q derivation gave 0.1429 vs the claimed 1.689 (91.5%), the audit confirmed 8/8 and proved the calibration state non-localized (the number is window-defined), and AF3 showed the benchmark implements the z20274505 mass-term spec rather than v11. M6 holds on its DM sector + the M7 lineage, exactly the branch-(b) contract |
