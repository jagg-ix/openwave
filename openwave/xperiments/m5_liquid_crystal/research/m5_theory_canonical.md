...
| Electron-hedgehog toy statics + twist spectrum | NO convergence at toy (g, δ): the Q8 slide is a SPREADING dilution (48k iters, interior, 3D-axisymmetric) and the endpoint is a SADDLE against time-mixing (all such directions ≈ −0.4: M5.18 indefiniteness at second order on the defect); perpendicular-twist dispersion is NOT KG-like at toy: roton-like minimum at k ≈ 0.1 (both grids), canonical-metric gap ω ≈ 0.10 in the M5.21 ring band (caveat: sliding background) | [m5_21_1 § 5, § 7](findings/m5_21_1_method_note.md) |
