...
| [`m5_question_tracker.md`](m5_question_tracker.md) | author-gated unknowns behind rows marked 🔶 (currently: Q24 formulation confirmation + the profile-dynamic/breathing clock question; the γ = −1 ask was withdrawn at M5.20.5; the tu → s calibration) |
