...
(Merged from the former `10n1_foundation_scope.md`, 2026-06-22 housekeeping. N1 + N2 were planned and run together on "go N1+N2"; foundation record: [`sandbox_v10/n_foundation_findings.md`](../sandbox_v10/n_foundation_findings.md).)
