...
- **Quantitative test**: `openwave/xperiments/m5_liquid_crystal/research/scripts/m5_1_coulomb.py`
- **Quantitative plot**: `research/plots/m5_1_coulomb.png` (E vs d + E vs 1/d linear fit)
- **Strategic context**: [`m5_1b_topological_defect.md § STRATEGIC MAPPING`](m5_1b_topological_defect.md) — wave vs topology decomposition; Coulomb listed under "FORCES — Topology"
- **M5.1 task entry**: [`m5_2a_path_to_m5.md § Phase M5.1 — task 7`](m5_2a_path_to_m5.md)
