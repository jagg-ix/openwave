...
**Cross-refs (current):** [0c_roadmap.md](0c_roadmap.md), [m5.3b_lagrangian_roadblocks.md](m5.3b_lagrangian_roadblocks.md), [m5.1a_lagrangian_framework.md](m5.1a_lagrangian_framework.md), `../theory/liquid_crystal_model.pdf` (Duda arxiv:2108.07896 v7), `../theory/liquid_crystal_particles.pdf` (Duda slides, 51 pages).
