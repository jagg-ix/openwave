...
| The standard this produced | [`dev_docs/METHOD_NOTE.md`](../../../../../dev_docs/METHOD_NOTE.md) (equations first, equation-to-code map, small auditable module): mandatory for every model-owner-facing report from now on. |
