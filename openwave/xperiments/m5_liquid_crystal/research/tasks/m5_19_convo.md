...
| Time-dilation remark | Radiation might exist but be near-negligible in lab frame (minutes from the Sun, Myr from supernovae): ⚠️ speculative, needs the clock/boost machinery | Deferred M5.21+ |
