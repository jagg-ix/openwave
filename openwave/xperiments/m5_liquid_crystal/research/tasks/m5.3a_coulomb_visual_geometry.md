...
- **Strategic context**: [`m5.1b_topological_defect.md § STRATEGIC MAPPING`](m5.1b_topological_defect.md) — wave vs topology decomposition; Coulomb listed under "FORCES — Topology"
- **M5.1 task entry**: [`m5.2a_path_to_m5.md § Phase M5.1 — task 7`](m5.2a_path_to_m5.md)
