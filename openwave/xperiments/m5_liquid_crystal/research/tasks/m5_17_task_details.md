...
| 7 | Renamed (user instruction at review): METHOD REPORT → **METHOD NOTE** across OpenWave, the local workspace, and memory; dual-use rationale (attached to reports alongside results & findings, or standalone internal audit) baked into the standard | ✅ |
