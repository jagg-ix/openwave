...
Option (c) is the richest and most LC-faithful — the literal "biaxial top at each voxel" picture from the Duda thread study ([`m5.4a_convo_2026.05.12.md` §5](m5.4a_convo_2026.05.12.md)). Recommend (b) as cheap interim, (c) as the showcase.
...
> `g`-axis boost — is derived in [`5a §10d`](m5.5a_lagrangian_evolution.md) (the M5.8 build spec); this
