...
> N-program finishes (per [`../10a_neutrino_oscillations.md`](../tasks/m5_10a_neutrino_oscillations.md) § "N1 + N2 foundation scope"). Local record. Builds
> on N3: [`n3_findings.md`](n3_findings.md). Master plan: [`../10a_neutrino_oscillations.md`](../tasks/m5_10a_neutrino_oscillations.md).
...
[`../10a_neutrino_oscillations.md`](../tasks/m5_10a_neutrino_oscillations.md) (N* plan) ·
