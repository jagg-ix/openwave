...
> lock + the P-G δ-continuation probe), report the deliverable to Duda, then the **M5.12
> pre-flight ask round** (ALL pending neutrino questions in one email: Q13 chiral invariant +
> loop-vs-knot, backed by the deliverable), then the re-entry runs as **M5.12** (fresh task,
> M5.11 closed ✅ 2026-07-02; this file is the frozen M5.11 archive), phase A uniaxial +
> the P2 2×2 re-run at the physical regime. Full plan: [`m5_12_task_details.md`](../tasks/m5_12_task_details.md); hypothesis + P-G + rigor bar: [`m5_16_task_details.md`](../tasks/m5_16_task_details.md).
