...
> Builds the sim → physical unit map for the M5 liquid-crystal substrate and computes the dimensionless invariants that test it. Driver: [`m5_8_2x_absolute_scale.py`](../scripts/m5_8_2x_absolute_scale.py) (pure-analysis; measured inputs sourced inline). Date 2026-06-17.
>
