...
Scripts (self-contained, numpy, headless): [`m5_9_1_lepton_mass_law.py`](../scripts/m5_9_1_lepton_mass_law.py), [`m5_9_2_clock_scaling.py`](../scripts/m5_9_2_clock_scaling.py). Both build on the M5.6.3b Faber-on-M machinery (`M = O D(s(r)) O^T`, curvature energy `integral ||[M_mu, M_nu]||^2`, Faber potential `V = (1-s^2)^3/r0^4`).
