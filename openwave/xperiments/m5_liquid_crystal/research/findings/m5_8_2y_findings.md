...
> Does turning V(M) on lift the clock ω toward the electron ZBW, closing the 28× gap (#208)? **Answer: no — the gap is largely structural.** Driver: [`m5_8_2y_gap_levers.py`](../scripts/m5_8_2y_gap_levers.py); the faithful-kinetic input re-run via [`../scripts/m5_6_5d_faithful_kinetic.py`](../scripts/m5_6_5d_faithful_kinetic.py). Date 2026-06-17.
>
