...
> [`../10a_neutrino_oscillations.md`](../tasks/m5_10a_neutrino_oscillations.md) § "N1 + N2 foundation scope" WORKFLOW NOTE, all GitHub #236
...
Scope + master plan:
[`../10a_neutrino_oscillations.md`](../tasks/m5_10a_neutrino_oscillations.md) · the SO(3)/TBM target:
...
**Payoff**: E_1 IS the theta_13 channel ([`../10a`](../tasks/m5_10a_neutrino_oscillations.md) § "the
...
([`../10a`](../tasks/m5_10a_neutrino_oscillations.md) § "Sub-tasks: phase-wired").
