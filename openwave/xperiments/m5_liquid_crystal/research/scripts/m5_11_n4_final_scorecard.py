...
Generates m5_11_n4_final_scorecard.png (theta13(g_chiral)+delta_CP unification; the delta_CP sign map; the 4-angle
scorecard vs NuFIT 6.0) and m5_11_n4_final_scorecard.json. Convention index-0. Headless. LOCAL (#236 HELD).
Run: python3 m5_11_n4_final_scorecard.py
"""
...
from m5_11_n3_theta13 import alpha_star
from m5_11_n4_chiral import chiral_mass_matrix, pmns_from_H
from m5_11_n3_derisk import NUFIT, TH12_TBM
