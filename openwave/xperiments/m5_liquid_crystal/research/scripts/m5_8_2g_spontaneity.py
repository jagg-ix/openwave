...
PROBE = 100
OUT_NPZ = HERE.parent / "data" / "_m5_8_2g_traces.npz"
...
def settle_main():
    ...
    np.savez(HERE.parent / "data" / "_m5_8_2g_settled.npz", M_settled=M_set,
...
def restart_main():
    ...
    z = np.load(HERE.parent / "data" / "_m5_8_2g_settled.npz")
    M_set = z["M_settled"]
    print("=" * 78)
