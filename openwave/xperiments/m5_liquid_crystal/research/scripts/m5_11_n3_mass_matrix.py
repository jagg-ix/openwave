...
with boost dressing (S3). Headless numpy f64. LOCAL (#236 N-program, HELD). Run: python3 m5_11_n3_mass_matrix.py
"""
...
from m5_11_n1_precision_method import SIGN_MAT, _grads, _comm, _sdot
...
def main():
    ...
    print("  next: m5_11_n3_search.py scans the geometry for magic_residual -> 0 = the TBM gate.")
    print("=" * 80)
