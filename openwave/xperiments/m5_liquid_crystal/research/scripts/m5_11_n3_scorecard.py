...
Generates m5_11_n3_summary.png (3 panels: the magic-crossing gate, the theta13(delta,eps) map, the mass spectrum)
and writes m5_11_n3_scorecard.json. Convention index-0. Headless. LOCAL (#236 N-program, HELD).
Run: python3 m5_11_n3_scorecard.py
"""
...
from m5_11_n3_mass_matrix import flavour_mass_matrix
from m5_11_n3_search import find_alpha_star
from m5_11_n3_theta13 import biaxial_mass_matrix, alpha_star
from m5_11_n3_derisk import TH12_TBM, NUFIT
