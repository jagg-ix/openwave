...
S1 (m5_11_n3_mass_matrix.py) showed the loop overlaps give a mu-tau matrix whose MAGIC residual (x+y)-(z+w)
...
LOCAL (#236 N-program, HELD). Run: python3 m5_11_n3_search.py
"""
...
from m5_11_n3_derisk import TH12_TBM
