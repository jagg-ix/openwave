#!/usr/bin/env python3
"""m5_11_theta13_breaking — where does theta_13 come from? (the SO(3)-breaking)
...
Run:  python3 m5_11_theta13_breaking.py
"""
import json
import os
import numpy as np
...
with open(os.path.join(DATA, "m5_11_theta13_summary.json"), "w") as f:
...
plt.tight_layout()
plt.savefig(os.path.join(PLOTS, "m5_11_theta13_breaking.png"), dpi=130)
plt.close()
...
# ---------------------------------------------------------------------------
print("=" * 72)
print("m5_11b — WHERE DOES theta13 COME FROM? (the SO(3)-breaking, #199 ext)")
print("=" * 72)
...
print("=" * 72)
print("Wrote data/m5_11_theta13_summary.json + plots/m5_11_theta13_breaking.png")
