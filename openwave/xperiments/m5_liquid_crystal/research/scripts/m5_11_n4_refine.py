...
Builds on m5_11_n4_chiral.py (the chiral complex-Hermitian mass matrix; delta_CP = +-90 predicted, robust). Two
...
Convention index-0. Headless f64, 16-core. LOCAL (#236 N-program, HELD). Run: python3 m5_11_n4_refine.py
"""
...
from m5_11_n4_chiral import _scan_point, chiral_mass_matrix, pmns_from_H
from m5_11_n3_theta13 import alpha_star
from m5_11_n3_derisk import NUFIT
