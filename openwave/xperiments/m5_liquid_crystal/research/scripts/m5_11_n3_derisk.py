...
from loops (m5_11_n3_mass_matrix.py), this file PROVES the scaffold on KNOWN matrices, so a later failure is
unambiguously a loop-physics issue, not a bookkeeping bug:
  ...
  D4  which breakings switch on theta13, and its sign + linearity:
      ...
      This maps the delta -> theta13 channel that m5_11_n3_theta13.py will source from the LC delta.
...
Run: python3 m5_11_n3_derisk.py
"""
...
from m5_11_n2_closed_loop import U_TBM, pmns_angles, _R
