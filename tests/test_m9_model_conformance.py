...
def test_honest_negative_is_preserved(): assert sum(c.status=="negative" for c in CRITERIA)==2
...
def test_m9_40_42_counts(): assert validate_profile()["status_counts"]=={"validated":0,"partial":15,"negative":2,"not_yet":3}
