...
def test_current_overlay_changes_exactly_three_rows():
...
def test_current_profile_preserves_status_and_validated_sets():
...
def test_current_findings_name_new_closures_and_shared_blocker():
